...
public class MainActivity extends AppCompatActivity {
    private RecyclerView rvDaftarVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new DaftarVideoAdapter(daftarVideo, this);
    ...
    public void isiDaftarVideo() {
        ...
        daftarVideo.add(new SumberVideo(
                "Drift H2H",
                "Cuplikan H2H dari film Fast and The Furious",
                "android.resource://" + getPackageName() + "/" + R.raw.drift01));

        daftarVideo.add(new SumberVideo(
                "Kejar-kejaran",
                "Kejar-kejaran di jalanan dari film Fast and The Furious",
